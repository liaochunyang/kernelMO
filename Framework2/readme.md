...
- **ood_par.h5**: parameter range $\pm20\%$  (in-distribution test range $\pm10\%$). This is the same ood as the MNO paper, i.e. The components of $\alpha$ are sampled from the ranges $\alpha_i \in [0.8\alpha_i^c,1.2\alpha_i^c]$.
